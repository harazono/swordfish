    ...
    'each_read: for current_sequence in sequences[start_idx..end_idx].iter() {
        ...
        'each_l_window: loop{
            ...
            'each_r_window: loop{
                ...
                //subsequence_as_LmrTupleはsubsequence_as_u64;3みたいなのにする
                let lmr_string = current_sequence.subsequence_as_LmrTuple([[l_window_start, l_window_end], [r_window_start, r_window_end], [r_window_start, r_window_end]]);
